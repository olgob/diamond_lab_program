# -*- coding: utf-8 -*-
"""
This module operates a 2D scan of a sample placed on a positionner in order to detect fluorescence from a single atom
...
class SampleScanLogic(GenericLogic):
    """
    This is the Logic class for the scanning of a cavity (2D).
    """
